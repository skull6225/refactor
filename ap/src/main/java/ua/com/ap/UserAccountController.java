...
import ua.com.ap.UserAccount;
import ua.com.ap.UserAccountRepository;
...
public class UserAccountController {
    ...
    /* 
     * Mapping url exmaple:
     * http://localhost:8080/userAccount/add?userName=Axe&password=111&email=ax@gmail.com
     */
    @GetMapping(path = "/add")
    @ResponseBody
    ...
    /*
     * Mapping url exmaple: 
     * http://localhost:8080/userAccount/findByName?userName=Bill
     */
    ...
    /*
     * Mapping url exmaple:
     * http://localhost:8080/userAccount/updateUser?userName=Jerry&password=123&
